...
int lefEncAPin = 3;   // Continuous pulses
int lefEncBPin = 2;   // Direction Switching Pulse
int lefMotPowPin = 12;
int lefMotCCWDirPin = 9;
int lefMotCWDirPin = 8;
...
int rigEncAPin = 19;   // Continuous pulses
int rigEncBPin = 18;   // Direction Switching Pulse
int rigMotPowPin = 13;
int rigMotCCWDirPin = 7;
int rigMotCWDirPin = 6;
...
{ // No. of count difference in a time interval
  ...
  //before executing nex t line since both lines have a small time interval
  //delay for running
  //noInterrupts();
  lefPreCou = lefEncCou; //May be add no interrept here too.
  //interrupts();
}
...
void rigMotRPMCal() 
{
  ...
  //delay for running
  //noInterrupts();
  rigPreCou = rigEncCou; //May be add no interrept here too.
  //interrupts();
}
